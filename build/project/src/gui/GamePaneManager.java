...
public class GamePaneManager {
	...
	private Label phaseTimeLeft = new Label();
	
	private GameEvent nextEvent;
	
	// == constructor ==
	public GamePaneManager(SceneManager sm, MainController controller, GameEvent nextEvent) {
		...
		bossHp.setLayoutX(20);
		bossHp.setLayoutY(20);
		bossHp.setFont(Font.font(20));
		
		phaseTimeLeft.setLayoutX(20);
		phaseTimeLeft.setLayoutY(50);
		phaseTimeLeft.setFont(Font.font(20));
		
		pane.getChildren().addAll(back, dialogPane, bossHp, phaseTimeLeft);
	}
	...
	public void refreshBossInfo() {
		if(controller.getGame().getBoss() != null) {
			bossHp.setText(controller.getGame().getBoss().getPhaseHp() + "");
			phaseTimeLeft.setText(controller.getGame().getBoss().getPhaseElapseTime() + "");
		}
	}
	
	public void nextEvent() {
		sm.setScore(controller.getGame().getScore());
		nextEvent.nextMove();
	}
